...
*/
/**************************************************************************/
int8_t i2c_readBlock(uint8_t dev_id, uint8_t reg_addr, uint8_t *reg_data, uint16_t len) 
{
   uint8_t ret;
   #ifdef BME680_DEBUG
...
/**************************************************************************/
/*!
    @brief  Write 8 bit values over I2C
*/
/**************************************************************************/
int8_t i2c_writeBlock(uint8_t dev_id, uint8_t reg_addr, uint8_t *reg_data, uint16_t len) 
{
   uint8_t ret;
   #ifdef BME680_DEBUG
     printf("I2C %d Reg=%d  <=  ",dev_id, reg_addr);
